...
def exchangeable_value(
    ...
    """
    full_rate = exchange_rate + ((spread / 100) * exchange_rate)
    money_value = exchange_money(budget, full_rate)
    return get_number_of_bills(money_value, denomination) * denomination
...
def non_exchangeable_value(
    ...
    return int(money_value - exchangable)
